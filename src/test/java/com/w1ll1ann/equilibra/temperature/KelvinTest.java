...
public class KelvinTest {
    ...
    public void testConversionToCelsius() {
        ...
        String actualOutput = Kelvin.convert(Float.toString(Kelvin.ABSOLUTE_ZERO), "--celsius");
    ...
    public void testConversionToFahrenheit() {
        ...
        String actualOutput = Kelvin.convert(Float.toString(Kelvin.ABSOLUTE_ZERO), "--fahrenheit");
    ...
    public void testInvalidConversion() {
        ...
        assertThrows(IllegalArgumentException.class, () -> Kelvin.convert(Float.toString(Kelvin.ABSOLUTE_ZERO - 1), "--celsius"));
        assertThrows(IllegalArgumentException.class, () -> Kelvin.convert(Float.toString(Kelvin.ABSOLUTE_ZERO - 1), "--fahrenheit"));
